...
# Site recharge
construction <- invisible(sf::st_read("../data/lignes_construction/6301-23-0104_20230504_ZoneTransfertAdministrationF0110.shp"))
construction[,"nom"] <- "Recharge"

# Bathymetry
bathy0 <- invisible(sf::st_read("../data/bathymetrie.geojson"))
bathy10 <- invisible(sf::st_read("../data/bathymetrie10.geojson"))
bathy10[1,"depth"] <- "-10m"

# Sites
sites <- invisible(sf::st_read("../data/zones.geojson"))
...
# Import stations
stations <- terra::vect("../data/soussites.geojson")
